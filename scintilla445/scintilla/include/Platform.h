...
#ifndef PLATFORM_H
#define PLATFORM_H
//#if defined(SCINTILLA_INLINE)
//#	define _SCINTILLA_API
//#else
//#define SCINTILLA_EXPORTS
//#	if defined(SCINTILLA_EXPORTS)
//#		define _SCINTILLA_API __declspec(dllexport)
//#	else
//#		define _SCINTILLA_API __declspec(dllimport)
//#	endif
//#endif
...
public:
	...
	constexpr void SetRGB(unsigned int red, unsigned int green, unsigned int blue)
		{
		co=(min(red, 255) | (min(green,255) << 8) | (min(blue,255) << 16));
	}
	#undef min
...
public:
	...
	bool SetPositionRelative(PRectangle rc, const Window *relativeTo,bool limit_rect=false);
...
public:
	...
	virtual void Update(int ctrlID_, Point location_, int lineHeight_, bool unicodeMode_, int technology_)=0;
