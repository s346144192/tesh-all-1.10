...
#ifdef SCINTILLA_IMPORT
	#define SCINTILLA_API __declspec(dllimport)
#else
	#ifdef SCINTILLA_EXPORT
		#define SCINTILLA_API __declspec(dllexport)
	#else
		#define SCINTILLA_API
	#endif
#endif
...
SCINTILLA_API int Scintilla_ReleaseResources(void);
#endif
SCINTILLA_API int Scintilla_LinkLexers(void);
...
#define STYLE_DEFAULT 52
#define STYLE_LINENUMBER 53
#define STYLE_BRACELIGHT 54
#define STYLE_BRACEBAD 55
#define STYLE_CONTROLCHAR 56
#define STYLE_INDENTGUIDE 57
#define STYLE_CALLTIP 58
#define STYLE_FOLDDISPLAYTEXT 59
#define STYLE_LASTPREDEFINED 59
...
#define SC_FOLDLEVELHIGHHEADERFLAG 0x4000
...
#define SCI_SETZOOMLEVELMINMAX 2801
...
typedef void(__stdcall MessageCommandCallback)(sptr_t ptr, int chidctrlid, int eventid);
typedef void(__stdcall MessageNotifyCallback)(sptr_t ptr, SCNotification* notify);
